                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">
                        <?php
                          $selectQuery = mysqli_query($conn, "SELECT * FROM `users`");
                            if ($totalusers = mysqli_num_rows($selectQuery)) {
                              echo '<span class="number">'.$totalusers.'</span>';
                            }
                            else{
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">
                        <?php
                          $selectQuery = mysqli_query($conn, "SELECT * FROM `urls`");
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">
                        <?php
                          $selectQuery = mysqli_query($conn, "SELECT * FROM `urls` WHERE status = '1'");
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2">
                        <?php
                          $selectQuery = mysqli_query($conn, "SELECT * FROM `urls` WHERE status = '0'");
